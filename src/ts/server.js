...
var ENGINE_NAME = "hbs";
app.engine(ENGINE_NAME, (0, express_handlebars_1.default)({
    extname: "." + ENGINE_NAME,
    layoutsDir: path_1.default.join(__dirname, '../views/layouts'),
    defaultLayout: path_1.default.join(__dirname, '../views/layouts/index.hbs'),
}));
    ...
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                ...
                _b = (_a = socket).emit;
                _c = ["messageList"];
                return [4 /*yield*/, (0, utils_1.getMessages)()];
            case 1:
                ...
                socket.on("new-message", function (data) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0:
                                messages.push(data);
                                return [4 /*yield*/, (0, utils_1.updateMessagesTxt)(messages)];
                            case 1:
                                _d.sent();
