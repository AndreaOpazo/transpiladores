...
exports.updateMessagesTxt = exports.getMessages = void 0;
...
var getMessages = function () { return __awaiter(void 0, void 0, void 0, function () {
    var messageListFileContent, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, promises_1.default.readFile('./messages.txt', 'utf-8')];
            case 1:
                messageListFileContent = _a.sent();
                return [2 /*return*/, JSON.parse(messageListFileContent)];
            case 2:
                error_1 = _a.sent();
                return [2 /*return*/, []];
            case 3:
...
var updateMessagesTxt = function (messages) { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, promises_1.default.writeFile('./messages.txt', JSON.stringify(messages))];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                error_2 = _a.sent();
                console.error("Se produjo un error al guardar el archivo.", error_2);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
}); };
exports.updateMessagesTxt = updateMessagesTxt;
